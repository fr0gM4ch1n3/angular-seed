...
export class SeedConfig {
  ...
  */
  ...
  /**
   * The flag for the targeting of mobile option of the application.
   * Per default the option is false.
   * @type {boolean}
   */
  TARGET_MOBILE = argv && argv._ && argv['mobile'];
   ...
   * @type {boolean}
   */
  TARGET_DESKTOP = argv && argv._ && argv['desktop'];
   ...
   * @type {boolean}
   */
  TARGET_WEB = (argv && argv._ && argv['web']) || (!this.TARGET_MOBILE && !this.TARGET_DESKTOP);
   ...
   * @type {string}
   */
  APP_BASE = (this.TARGET_DESKTOP || this.TARGET_MOBILE) ? '' : argv['base'] || '/';
  APP_BASE_HREF = (this.TARGET_DESKTOP || this.TARGET_MOBILE) ? 'index.html' : argv['base'] || '/';
  ...
  BOOTSTRAP_ELECTRON_MODULE = `${this
    .ELECTRON_FILE}`;
  ...
  /**
   * The folder for the built files of electron.
   * @type {string}
   */
  ELECTRON_DEST = `${this.DIST_DIR}/desktop`;

  /**
   * The folder for the built files of cordova.
   * @type {string}
   */
  CORDOVA_DEST = `${this.DIST_DIR}/desktop`;
  ...
  /**
   * The folder for temporary files of electron.
   * @type {string}
   */
  ELECTRON_CACHE_DIR = `${this.DIST_DIR}/cache`;
  ...
  /**
  * The version of electron for the package.
  * @type {string}
  */
  ELECTRON_VERSION = 'v2.0.7';

  /**
  * Enable Electron packaging.
  * @type {boolean}
  */
  ELECTRON_PACKAGING = true;
  ...
  /**
   * The name of the bundle file to include all JavaScript electron files.
   * @type {string}
   */
  JS_PROD_ELECTRON_BUNDLE = 'electron.js';
  ...
  */
  ...
  SYSTEM_CONFIG_DEV: any = {
    ...
    paths: {
      ...
      '@ngx-translate/core': 'node_modules/@ngx-translate/core/bundles/ngx-translate-core.umd.js',
      '@ngx-translate/http-loader': 'node_modules/@ngx-translate/http-loader/bundles/ngx-translate-http-loader.umd.js',
  ...
  constructor() {
    if (argv && argv._) {
      if (argv['desktop']) {
        ...
        this.TARGET_MOBILE = true;
      } else {
        this.TARGET_WEB = true;
      }
    }
  }
